...
<body>
    ...
    <table class="tablelist">
       ...
       <s:iterator value="#request.store">
       		<tr>
       			<td width="left"><input name="" type="checkbox" value="" /></td>
        		<td align="left">${storeId}</td>
        		<td align="left">${playTab.playName}</td>
        		<td align="left">${oldprice}</td>
        		<td align="left">${newprice}</td>
