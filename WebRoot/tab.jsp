...
<body>
    ...
    <div class="formtext">Hi，<b>${session.user.username}</b>，欢迎您试用信息发布功能！</div>
    
    <ul class="forminfo">
    <li><label>招聘企业<b>*</b></label><input name="" type="text" class="dfinput" placeholder="请填写单位名称"  style="width:518px;"/></li>
